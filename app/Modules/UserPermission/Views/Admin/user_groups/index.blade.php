...
<div class="">
    ...
    <div class="x_panel">
        <div class="x_content">
            ...
            <a href="{{route('admin_setting_index')}}" class="btn btn-app"><i class="fa fa-gear"></i> Cài đặt</a>
    ...
    <div class="x_panel">
        <div class="x_title">
            <h2><i class="fa fa-list"></i> User Groups</h2><div class="clearfix"></div>
        </div>
        <div class="x_content">
            <table class="table table-bordered" >
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>
                            <a href="{{route('mdle_ug_pers',$v->id)}}" class="btn btn-default btn-xs"><i class="fa fa-edit"></i> Permissions</a>
