...
<div class="">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{route('mdle_oc_index',$id_course)}}">Chương</a></li>
    </ol>

    <div class="x_panel">
        <div class="x_content">
            <a href="{{route('mdle_oc_index')}}" class="btn btn-app" ><i class="fa fa-arrow-left"></i>Quay lại</a>
            <a href="{{route('mdle_oc_chapter_add',$id_course)}}" class="btn btn-app"><i class="fa fa-book"></i> Tạo chương</a>
    ...
    <div class="x_panel">
        <div class="x_title">
            <h2>Quản lý chương <small>{{$course_info->name}}</small></h2>
            <div class="clearfix"></div>
        </div>
        <div class="x_content">
            ...
            <div class="row">
                <div class="col-md-12">
                    @include('OnlineCourse::Pi.parts.chapter_datatable')
                </div>
            </div>
