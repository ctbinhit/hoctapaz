@include('OnlineCourse::Pi/jsc/chapter_datatable')
...
<table class="table table-striped" id="table_controller">
    ...
    <tbody>
        ...
        <tr class="item-select" id="item-select-{{$v->id}}" data-id="{{$v->id}}" data-tbl="{{$v->tbl}}">
            ...
            <td>
                <a href="{{route('mdle_oc_chapter_edit',[$v->id_course,$v->id])}}">
            ...
            <td>
                ...
                <a href="{{route('mdle_oc_lesson_index',[$course_info->id,$v->id])}}" class="btn btn-primary">
                    <i class="fa fa-book"></i> Bài học</a>
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                        <li><a href="{{route('mdle_oc_chapter_edit',[$v->id_course,$v->id])}}"><i class="fa fa-edit"></i> Sửa</a></li>
