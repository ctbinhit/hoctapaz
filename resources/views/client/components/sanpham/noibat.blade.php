<div class="product-area">
    <div class="product-area-title">Sản phẩm nổi bật 
        <small><a href="{{route('client_product_highlight')}}" title="Click vào đây để xem thêm...">Xem thêm</a></small></div>
    <div class="product-items">
        @foreach($sanphamnoibat as $k=>$v)
