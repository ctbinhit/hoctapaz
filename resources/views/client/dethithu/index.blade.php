...
<div class="examonline">
    <div class="sup-nav">
        ...
        <a href="{{route('mdle_client_doc_index')}}">Tài liệu học</a> 
        @isset($this_cate)
        ...
        <div class="l_panel">
            ...
            <div class="l-content">
                <ul class="list-simple">
                    ...
                    <li><a href="{{route('mdle_client_doc_category',$v->name_meta)}}"><i class="fa fa-book"></i> {!! $v->name !!}</a></li>
                    @endforeach
                </ul>
            </div>
        </div>
    ...
    <div class="exam-right">
        ...
        <div class="r-panel">
            ...
            <div class="r-content">
                <ul class="r_tabs">
                    <li class="{{$type==null?'active':''}}"><a href="{!! route('mdle_client_doc_index') !!}"><i class="fa fa-list-ul"></i> Tất cả</a></li>
                    <li class="{{$type=='pdf'?'active':''}}"><a href="{!! route('mdle_client_doc_type', 'pdf') !!}"><i class="fa fa-file-pdf-o"></i> PDF</a></li>
                    <li class="{{$type=='word'?'active':''}}"><a href="{!! route('mdle_client_doc_type', 'word') !!}"><i class="fa fa-file-word-o"></i> Word</a></li>
                    <li class="{{$type=='pdftp'?'active':''}}"><a href="{!! route('mdle_client_doc_type', 'pdftp') !!}"><i class="fa fa-file-pdf-o"></i> PDF tính phí</a></li>
                    <li class="{{$type=='wordtp'?'active':''}}"><a href="{!! route('mdle_client_doc_type', 'wordtp') !!}"><i class="fa fa-file-word-o"></i> Word tính phí</a></li>
                </ul>
                <div class="documents">
                    <div id="data-items">
