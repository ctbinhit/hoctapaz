...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
            ...
            <style>
                #ttNganluong {
                    background: url("{{asset('public/client_assets/images/naptien/napthe.png')}}") no-repeat scroll 0 0 transparent;
                    border: 0 none;
                    cursor: pointer;
                ...
                <table align="center">
                    ...
                    <tr>
                        <td colspan="3">
                            <table>
                                <tr>
                                    <td style="padding-left:0px;padding-top:5px" align="right" ><label for="92"><img  src="{{asset('public/client_assets/images/naptien/mobifone.jpg')}}" /></label> </td>
                                    <td style="padding-left:10px;padding-top:5px"><label for="93"><img  src="{{asset('public/client_assets/images/naptien/vinaphone.jpg')}}" /></label></td>
                                    <td style="padding-top:5px;padding-left:5px" align="left"><label for="107"><img  src="{{asset('public/client_assets/images/naptien/viettel.jpg')}}" width="110" height="35" /></label></td>
                                    <td style="padding-top:5px;padding-left:5px" align="left"><label for="121"><img width="100" height="35" src="{{asset('public/client_assets/images/naptien/vtc.jpg')}}"></label> </td>
                                    <td style="padding-top:5px;padding-left:5px" align="left"> <label for="120"><img width="100" height="35" src="{{asset('public/client_assets/images/naptien/gate.jpg')}}"></label></td>
                                </tr>
                                <tr>
