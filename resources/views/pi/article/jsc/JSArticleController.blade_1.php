<script>
    ...
    function loadData() {
        $.ajax({
            url: '{{route("admin_article_ajax")}}',
            type: 'POST',
            dataType: 'json',
            beforeSend: function () {
                $('.table tbody').append('<tr class="odd"><td colspan="9" class="dataTables_empty">Loading...</td></tr>');
            },
            headers: {
    ...
    function init_datatbl(data) {
        datatbl = $('.jquery-datatable').DataTable({
            keys: true,
            select: true,
            data: data,
            "columns": [
            ...
            buttons: [
                ...
                {
                    extend: 'selectAll',
                    text: '<i class="fa fa-clipboard"></i> Select all'
                },
                {
                    extend: 'selectNone',
                    text: '<i class="fa fa-clipboard"></i> Deselect all'
                },
                {
                    extend: 'copy',
                ...
                {
                    extend: 'pdfHtml5',
                    text: '<i class="fa fa-file-pdf-o"></i> View PDF',
                    download: 'open'
                },
                {
                    extend: 'pdf',
                ...
                },
                {
                    ...
                    text: '<i class="fa fa-save"></i> Save current page', // Button text
                    ...
                    message: '123', // Optional description message that will be shown above the table in the created PDF. Please note that this option is now deprecated in favour of the
            ...
            // Bỏ các thuộc tính sort & search cho các cột không cần thiết
            "columnDefs": [{
                    "searchable": false,
                    "orderable": false,
                    "targets": [0, 1, 3]
