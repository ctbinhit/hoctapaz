                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10 col-sm-10 col-xs-12">
                                        @if(count($cates)!=0)
                                        <select class="form-control" name="id_category1" id="id_category_lv1">
                                            <option value="-1">- Danh mục môn học -</option>
                                            @foreach($cates as $k=>$v)
                                            @if(isset($item))
                                            @if($item->id!=null)
                                            @if($item->id_category_parent == $v->id)
                    ...
                    <div class="">
                        ...
                        <div class="form-group">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <a href="{{route('pi_exam_index')}}" class="btn btn-default">{{__('label.quaylai')}}</a> 
                    ...
                    <div class="form-group">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body" style="height: 407px;padding:0;">
                                <embed style="width: 100%;height:99%;" src="{{$item->file_pdf}}" />
                            </div>
                        </div>
                    </div>
                    @endisset
