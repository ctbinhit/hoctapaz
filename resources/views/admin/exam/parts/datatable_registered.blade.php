...
<table id="jquery-datatable-default" class="table table-bordered table-effect">
    <thead>
        <tr>
            ...
            <th width="10%" data-toggle="tooltip" data-placement="top" title="Đối tác"><i class="fa fa-user"></i></th>
            ...
            <th data-toggle="tooltip" data-placement="top" title="Ngày hết hạn"><i class="fa fa-calendar-o"></i></th>
    ...
    <tbody>
        ...
        <tr id="jquery-icheck-{{$v->id}}">
            ...
            <td data-toggle="tooltip" data-placement="top" title="{{$v->user_email}}"><a href="#">{{@$v->pi_name}} <i class="fa fa-eye"></i></a></td>
            <td data-toggle="tooltip" data-placement="top" title="{{$v->name}}"><a href="{{route('admin_examman_approver_detail',$v->id)}}">{{str_limit($v->name,30)}} <i class="fa fa-eye"></i></a></td>
            ...
            <td data-toggle="tooltip" data-placement="top" title="{{ Carbon\Carbon::parse($v->start_date)->format('d-m-Y h:i:s') }}"><i class="label label-info">{{diffInNow($v->start_date)}}</i></td>
            <td data-toggle="tooltip" data-placement="top" title="{{ Carbon\Carbon::parse($v->expiry_date)->format('d-m-Y h:i:s') }}"><i class="label label-info">{{diffInNow($v->expiry_date)}}</i></td>
            <td style="width: 10%;"><div class="label label-success"><i class="fa fa-check"></i> </div></td>
            <td>
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="{{route('admin_examman_approver_detail',$v->id)}}" class=""><i class="fa fa-minus-square"></i> Hủy</a></li>
                    </ul>
                </div>
