...
<div class="">
    <div class="page-title">
        <div class="title_left">
            <h3><i class="fa fa-gear"></i> Facebook API <small> Cấu hình</small></h3>
        ...
        <div class="x_content">
            ...
            <form class="form form-horizontal" method="POST" action="{{route('_admin_setting_account_facebook')}}">
                ...
                <div class="form-group">
                    <label for="app_id" class="control-label col-lg-2 col-md-2 col-sm-3 col-xs-12">ID Ứng dụng:</label>
