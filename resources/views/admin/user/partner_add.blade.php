...
<div class="">
    ...
    <form class="form-horizontal form-label-left" action="{{route('_admin_user_partner_save')}}" method="POST">
        {{ csrf_field() }}
                ...
                <div class="x_content">
                    ...
                    <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12 col-md-offset-3">
                            <a href="{{route('admin_user_partner')}}" class="btn btn-primary">Quay lại</a>
